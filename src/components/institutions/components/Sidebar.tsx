...
const NavLinks = [
    ...
    { name: "Wallet Account", href: "wallet_account", icon: <Wallet /> },
    { name: "Create Certificate", href: "create_certificate", icon: <Create /> },
    { name: "NFT Collection", href: "create_certificate", icon: <Create /> },
    { name: "Admins", href: "identity_admin", icon: <People /> },
];
